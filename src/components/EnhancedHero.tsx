...
const EnhancedHero = () => {
  // Parallax background - Fix the position issue
  const bgRef = useRef<HTMLDivElement>(null);
  const { scrollY } = useScroll();
  // Move bg image up to 50px on scroll - simplified calculation
  ...
  return (
    <section className="relative min-h-screen overflow-hidden">
      ...
      >
        {/* Fixed Parallax Background - Changed to simpler implementation */}
        <motion.div
          ref={bgRef}
          style={{ y }}
        ...
        <div className="relative z-10 container mx-auto px-4 min-h-screen flex items-center">
          <div className="grid md:grid-cols-2 gap-12 items-center w-full">
            ...
            {/* Animated Floating Images - Simplified to avoid scroll issues */}
            <motion.div
              initial="hidden"
              animate="visible"
